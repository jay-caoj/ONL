...
platform_bootcmd='nand read 0x9000000 0x4000000 0x1000000; setenv bootargs console=$consoledev,$baudrate onl_platform=powerpc-centec-e580-48x6q-r0; bootm 0x9000000'
